...
// export default function CarteiraView() {
//     // ... (state e handle functions) ...

//     // ... (useEffect blocks) ...

//     // O retorno deve ter flex: 1 para ocupar toda a tela
    // return (
    //     <SafeAreaView style={{ flex: 1 }}> {/* Adicione flex: 1 aqui */}
    //         <View style={{ padding: 16, flex: 1 }}> {/* E aqui */}
                
    //             {/* 1. SEÇÃO DE SALDOS (Topo da Tela) */}
    //             <View style={{
    //                 flexDirection: "row",
    //                 justifyContent: "space-between",
    //                 marginBottom: 20 // Adiciona margem para separar da lista
    //             }}>
    //                 {/* Saldo Dinheiro */}
    //                 <View style={{ flex: 1 }}> 
    //                     <Text style={{fontSize: 20, fontWeight: "bold"}}>Saldo Dinheiro</Text>
    //                     <Text style={{fontSize: 16 }}>{carteira?.saldoDinheiro}</Text>
    //                 </View>
    ...
    //             {/* 2. SEÇÃO DE EXTRATO (Ocupa o Resto do Espaço) */}
    //             <View style={{ flex: 1 }}> {/* ESSENCIAL: Permite que FlatList ocupe o restante da tela */}
    //                 {extrato && extrato.length > 0 ? (
    //                     <FlatList 
    //                         data={extrato}
    //                         keyExtractor={(item) => item.id.toString()}
    ...
    //                                 elevation: 4, 
    //                                 borderWidth: 1, 
    //                                 marginBottom: 10 // Adiciona espaço entre os itens
    //                             }}>
    //                                 <View>
    //                                     <Text>Valor Dinheiro: {item.valorDinheiro}</Text>
    //                                 </View>
    //                                 <View>
    //                                     <Text>Valor Milhas: {item.valorMilhas}</Text>
    //                                 </View>
